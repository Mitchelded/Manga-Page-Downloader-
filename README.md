...
This project operates under the [MIT License](LICENSE), granting you the freedom to modify, use, and distribute the software as you see fit. Refer to the `LICENSE` file for complete details.
